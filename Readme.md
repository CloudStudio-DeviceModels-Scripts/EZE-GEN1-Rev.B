...
# Parsing + Configuration Script – EZE-GEN1 - Rev. B

This **Parsing + Configuration** script is designed for the **EZE-GEN1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EZE-GEN1 Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **EZE-GEN1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
